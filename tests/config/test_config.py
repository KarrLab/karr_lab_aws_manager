...
class TestConfig(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.credentialsFileX = config.credentialsFile(credential_path = 'some_nonsense')
    ...
    def test_file_config(self):
        ...
        self.assertEqual(self.credentialsFileX.AWS_SHARED_CREDENTIALS_FILE, "/.wc/third_party/aws_credentials.ini")
